...
import "./App.css";
//This imports necessary to change pages, I will use more than one page so instead display everything what is in app.js
  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="/createOrDisplayList"
          element={CustomerCreateOrDisplay()}
        />
        <Route
          path="/pickListToDisplay"
          element={CustomerPickListsToDisplay()}
        />
      </Routes>
    </div>
  );
